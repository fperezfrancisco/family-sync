...
if (process.env.NODE_ENV === "production") {
    console.log("🛡️  Production rate limiting: 100 general requests, 50 auth requests per 15 minutes");
    console.log("🔒 Family-friendly login/register limiting: 30 attempts per 15 minutes");
